const notes = {
  ...
  "what-to-eat-lisbon": {
    ...
    htmlBody: [
      ...
      "<strong>Panda Cantina</strong> (pick the fried tofu, it's amazing)<br>",
      "<strong>O Satélite</strong> (typical Portuguese food. Try a bitoque com molho or secretos de porco)<br>",
      "<strong>Java Rooftop</strong> (cute rooftop. Decent food, good drinks)<br>",
      "<br>",
      "<strong>Dinner:</strong><br>",
      "<strong>Lero Lero</strong> (Lisbon's best pizza. Get the Piccante!!! They also have a great selection of wines + a great atmosphere)<br>",
      "<strong>Da Noi</strong> (intimate, good food)<br>",
      "<strong>Rosamar</strong> (seafood, nice place, good drinks. I always order at least one espresso martini)<br>",
      "<strong>Bar Alimentar</strong><br>",
      "<strong>Skizzo</strong><br>",
      "<strong>Familjen</strong><br>",
      "<strong>O Velho Eurico</strong><br>",
      "<strong>Magnolia</strong> (wine + nice food). There are several good spots nearby to have a drink before or after.<br>",
      "<br>",
      "<strong>Wine:</strong><br>",
      "<strong>Tati Tati</strong> (also good food)<br>",
      "<strong>A Viagem das Horas</strong><br>",
      "<strong>Vino Vero</strong><br>",
      "<strong>Bom Bom Bom</strong><br>",
      "<strong>NATA</strong><br>",
      "<strong>Magnolia</strong> (try the baked Brie)<br>",
      "<strong>Black Sheep</strong> (take your glass to the park)<br>",
      "<strong>Senhor Uva</strong> (also good food)",
    ].join("\n"),
  },
};
